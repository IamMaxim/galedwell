...
public class NPCUpdateMessage implements IMessage {
     ...
     */
    public static class ClientHandler implements IMessageHandler<NPCUpdateMessage, IMessage> {
        @Override
     ...
     * Created by maxim on 11/9/16 at 6:57 PM.
     */
    public static class ServerHandler implements IMessageHandler<NPCUpdateMessage, IMessage> {
        @Override
        public IMessage onMessage(NPCUpdateMessage message, MessageContext ctx) {
