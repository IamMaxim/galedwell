...
public class EquipMessage implements IMessage {
     ...
     */
    public static class ClientHandler implements IMessageHandler<EquipMessage, IMessage> {
        @Override
     ...
     * Created by maxim on 7/29/16 at 12:07 PM.
     */
    public static class ServerHandler implements IMessageHandler<EquipMessage, IMessage> {
        @Override
        public IMessage onMessage(EquipMessage message, MessageContext ctx) {
