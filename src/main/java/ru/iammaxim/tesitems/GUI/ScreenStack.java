...
public class ScreenStack extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (ResManager.enableBlur && Minecraft.isFancyGraphicsEnabled()) {
            ...
            if (ResManager.gaussianBlurShader != null && ResManager.gaussianBlurShader.getFramebufferRaw("swap").framebufferTextureWidth != mc.displayWidth ||
    ...
    public static void processCallback(String action, Object object) {
        instance.screens.forEach(s -> s.processCallback(action, object));
    }
}
